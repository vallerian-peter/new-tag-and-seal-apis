...
class ExtensionOfficerGetLivestockFormAction{
    public function handle(Request $request){
        $getLivestockDetails = Livestock::where('id',$request->cattleId)->first();
        ...
        'stages.id','=','livestock_stages.stage_id')->select('stages.name')->where('livestock_stages.livestock_id',$getLivestockDetails->id)->value('name');
