...
class ExtensionOfficerGetFarmProfileFormAction
{
    public function handle(Request $request)
    {
        ...
        $getFarmDetails = Farm::join('extension_officers', 'farms.created_by', '=', 'extension_officers.id')
         ...
         as units'
            ...
            ->where('extension_officers.id', $getOfficerDetails->id)
            ->get();
        // echo json_encode($getFarmDetails);exit;
