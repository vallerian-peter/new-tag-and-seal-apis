...
class Vet extends Model
{
    ...
    protected $fillable = [
        'registration_no', 'name', 'phone_1', 'phone_2', 'email', 'address', 'medical_licence_no', 'date_of_birth', 'gender_id',
        'identity_card_type_id', 'identity_number', 'street_id', 'school_level_id', 'village_id',
        'ward_id', 'division_id', 'district_id', 'region_id', 'country_id', 'farmer_type_id', 'created_by',
        'updated_by', 'status_id', 'is_verified', 'created_at', 'updated_at'
    ];
    ...
    {
        return $this->hasMany(VetAttachment::class, 'vet_id');
    }

    public function farms()
    {
        return $this->hasMany(VetFarm::class, 'vet_id');
    }
