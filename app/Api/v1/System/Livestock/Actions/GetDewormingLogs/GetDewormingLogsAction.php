...
namespace App\Api\v1\System\Livestock\Actions\GetDewormingLogs;

use App\Models\Deworming;
use App\Models\FarmLivestock;

class GetDewormingLogsAction
{
...
//        $logs = [];
        ...
        if(count($livestocks) > 0){
            ...
            for($i=0;$i<count($livestocks);$i++){
                ...
                $livestocks[$i]['logs'] = Deworming::where('livestock_id',$livestocks[$i]['id'])->get();
            }
        }
