...
namespace App\Api\v1\System\Livestock\Actions\GetMedicationLogs;

use App\Models\FarmLivestock;
use App\Models\Medication;

class GetMedicationLogsAction
{
...
//        $logs = [];
        ...
        if(count($livestocks) > 0){
            ...
            for($i=0;$i<count($livestocks);$i++){
                ...
                $livestocks[$i]['logs'] = Medication::where('livestock_id',$livestocks[$i]['id'])->get();
            }
        }
